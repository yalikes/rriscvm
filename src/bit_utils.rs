pub fn u32_assemble(x0: u8, x1: u8, x2: u8, x3: u8) -> u32 {
    // x0: LSB, x3:MSB
    ((x3 as u32) << 24) | ((x2 as u32) << 16) | ((x1 as u32) << 8) | (x0 as u32)
}
...
pub fn s_sign_extend(imm: u16) -> u32 {
    let imm = imm as u32;
    let imm11 = (imm >> 11) & 0b1;
    imm11 * 0xff_ff_f8_00 | imm  & 0x07ff
}
...
pub fn j_sign_extend(imm: u32) -> u32 {
    ...
    imm20 * 0xfff0_0000 | imm12 << 12 | imm11 << 11 | imm1 << 1
}
...
fn test_j_sign_extend() {
    assert_eq!(
        j_sign_extend(0b1000_1111_0000_1111_0000),
        0b1111_1111_1111_1111_0000_0000_1111_0000
    );
}
...
fn test_u_sign_extend() {
    assert_eq!(
        b_sign_extend(0b1_010101_1111_1),
